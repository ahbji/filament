...
public class View {
    ...
    public static class DynamicResolutionOptions {
         ...
         */
        public float minScale = 0.5;
        /**
         * maximum scale factors in x and y
         */
        public float maxScale = 1.0;
        /**
    ...
    public static class FogOptions {
         ...
         */
        @NonNull @Size(min = 3)
        public float[] color = { 0.5, 0.5, 0.5 };
        /**
    ...
    public static class VignetteOptions {
         ...
         */
        @NonNull @Size(min = 4)
        public float[] color = { 0.0, 0.0, 0.0, 1.0 };
        /**
    ...
    public static class AmbientOcclusionOptions {
        ...
        public AmbientOcclusionOptions::Ssct ssct = ;
    };
